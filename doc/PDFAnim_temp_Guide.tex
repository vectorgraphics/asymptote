...
%\GetFileInfo{pdfanim_temp.sty}

\title{The \textsf{PDFAnim\_temp} package}
\author{Jochen Skupin (Version 0.52A, modified by John Bowman)}
\date{\today}
\maketitle
...
\changes{v0.52A}
	{2006/11/26}{Second published version (included with Asymptote 1.19)}
...
\section{Introduction}
  PDFAnim\_temp is an interim \LaTeX\ package to create animated PDFs with
  pdf\LaTeX. It will become obsolete as soon as the 0.53 release of PDFanim
  is made.
...
\begin{itemize}
\item PDF\LaTeX
\item the PDFAnim package (i.e. the |pdfanim_temp.sty|-file)
...
Another command, |\PDFAnimButtons|, which is available if you also load
