...
% This makes LaTeX symbols visible to \begin{asy}...\end{asy} environments.
% In this mode, Asymptote correctly aligns LaTeX symbols defined
% outside of  \begin{asy}...\end{asy}, but treats their size as zero.
% Labels might not show up in dvi viewers that cannot handle raw postscript
% code; use dvips/dvipdf to produce PS/PDF output.
