...
% Uncomment the next 2 lines to use "pdflatex -shell-escape" instead of latex
%\usepackage[pdftex]{graphicx}
%\usepackage{epstopdf}
%
% Note: to use inline mode with pdflatex see
% http://sourceforge.net/forum/message.php?msg_id=3820188
% http://sourceforge.net/forum/message.php?msg_id=3820228
