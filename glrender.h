...
// vkrender.h also defines these store() functions in namespace camp.
// Only define them here when not compiling with Vulkan support.
#ifndef HAVE_VULKAN
...
// Runtime flag set when Vulkan is compiled in but unavailable at runtime,
// causing a fallback to the OpenGL renderer.
extern bool glFallback;
...
#ifdef HAVE_LIBGLM
// render.h (included via vkrender.h when HAVE_VULKAN) also defines MaterialMap
// in namespace camp. Guard against the conflict.
#ifndef HAVE_VULKAN
