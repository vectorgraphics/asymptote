...
// TODO: Create a way to pass operator==(A, A) to the template, either implicitly or explicitly.
// from "template/imports/wrapperWithEquals"(T=A) access Wrapper_T as Wrapper_A, wrap, operator ==, alias;  // error
