...
def read_input_sections(d: RunData) -> tuple[List[str], List[str]]:
...
def process_sections(
    d: RunData, sections_in: List[str], sections_base: List[str], outSrcFile: str
) -> List[str]:
...
def finalize_output(
    outHeaderFile: str, outSrcFile: str, header_lines: List[str]
) -> None:
    header_lines.append("}\n\n")
