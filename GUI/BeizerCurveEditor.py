...
class BeizerPoint:
    ...
    def fromQStandardItem(cls, pointItem):
        """
        Creates a Beizer point from the following data structure:
        ---------------------------
        Point             | X | Y |
        ...
        return BeizerPoint(mainPoint, lCtrlPoint, rCtrlPoint, pointItem.text())
...
class BeizerCurveEditor(Qw.QDialog):
    ...
    def createPointList(self):
        ...
        for pointIndex in range(self.model.rowCount()):
            ...
            self.pointList.append(BeizerPoint.fromQStandardItem(pointItem))
    ...
    def addPoint(self):
        ...
        point = BeizerPoint(Qc.QPointF(x, y), Qc.QPointF(px, py), Qc.QPointF(qx, qy),
