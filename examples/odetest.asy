...
write(integrate(1,f,0,100,0.1,dynamic=true,0.0002,0.0004,RK5CK,verbose=true));
write();

write("system integration test");
real[] f(real t, real[] x) {return new real[] {x[1],1.5*x[0]^2};}
write(integrate(new real[] {4,-8},f,0,1,n=100,dynamic=true,tolmin=0.0002,tolmax=0.0004,RK3BS,verbose=true));
write();
